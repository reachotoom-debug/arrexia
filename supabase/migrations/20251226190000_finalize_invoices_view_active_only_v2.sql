-- ============================================================================
-- FINTECH/AR HARD FIX v2: Ensure invoices_view NEVER includes archived invoices
-- ============================================================================
-- 
...
-- 2. Payment aggregation: WHERE p.archived_at IS NULL (excludes archived payments)
-- ============================================================================
