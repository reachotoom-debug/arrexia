...
begin
  if exists (
    ...
    execute $view$
      ...
      -- PUT YOUR FULL VIEW SQL HERE (same body you already have),
      -- but reference public.invoices explicitly:
    ...
    raise notice 'Skipping invoices_view creation: public.invoices does not exist yet.';
  end if;
end $$;
