-- ============================================================================
-- Finalize invoices_view to exclude archived invoices (AR integrity fix)
-- ============================================================================
-- 
-- This migration ensures invoices_view ALWAYS excludes archived invoices
-- to prevent archived invoices from appearing in active invoice lists.
--
