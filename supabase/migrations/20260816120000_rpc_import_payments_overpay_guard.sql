-- ============================================================================
-- Payment import overpayment guard (P1 launch blocker)
-- ============================================================================
-- Adds authoritative outstanding validation to rpc_import_payments:
-- - Matches invoices_view paid semantics (completed, paid, NULL)
-- - Re-import/update releases existing effective payment before validating
-- - Batch cumulative validation per invoice within a single import call
-- - Invoice row lock (FOR UPDATE) for concurrent import safety
-- Preserves upsert/dedupe, workspace scoping, and existing row-level error handling.
-- ============================================================================
