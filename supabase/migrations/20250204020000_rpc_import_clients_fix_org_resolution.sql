-- ============================================================================
-- Fix RPC Import Clients: Resolve organization_id from existing workspace data
-- ============================================================================
-- 
-- This migration fixes rpc_import_clients to:
-- - Stop querying workspaces.organization_id (column doesn't exist)
...
-- - Use ON CONFLICT with WHERE clauses for partial unique indexes
-- 
-- ============================================================================
