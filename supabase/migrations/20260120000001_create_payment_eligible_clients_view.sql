...
-- ============================================================================
-- 
-- Clients with at least one invoice where:
--   - outstanding > 0
--   - display_status IN ('sent', 'overdue', 'partially_paid')
-- 
-- Uses invoices_view (NOT invoices table) for financial fields
-- ============================================================================
...
COMMENT ON VIEW public.payment_eligible_clients IS 
  'Clients with at least one eligible invoice for payment recording. Uses invoices_view for financial fields (outstanding, display_status), invoices table for archived_at filter.';
  $sql$;
