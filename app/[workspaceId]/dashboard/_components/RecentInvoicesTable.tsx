        ...
        <table className={TABLE_BASE}>
          <thead>
            <tr className="border-b border-slate-100 text-xs font-medium text-slate-500">
              <th className={clsx("px-3 py-3 uppercase tracking-wider whitespace-nowrap", INVOICE_NUMBER_COL_CLASS)}>INVOICE #</th>
          ...
          <tbody className="divide-y divide-slate-100">
            {invoices.map((invoice) => (
              ...
              >
                ...
                <td className="min-w-0 px-3 py-3 text-slate-800 break-words">
                ...
                <td className="px-3 py-3 text-right font-medium text-slate-900 whitespace-nowrap tabular-nums">
                  {invoice.amount ?? invoice.total
                    ? formatCurrency(invoice.amount ?? invoice.total ?? 0, { currency: "USD" })
                    : "—"}
                </td>
