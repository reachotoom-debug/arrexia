...
export function RecentActivity({ invoices, workspaceId }: RecentActivityProps) {
  const [activeTab, setActiveTab] = useState<ActivityTab>("invoices");
