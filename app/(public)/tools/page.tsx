...
import { ALL_TOOLS } from "@/lib/tools/catalog";
    ...
    <PublicPageShell>
      <main className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
        <section className="mx-auto max-w-3xl text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.24em] text-blue-600">Tools</p>
          <h1 className="mt-4 text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl lg:text-5xl lg:leading-tight">
            Free tools to improve your cash flow and collections
          </h1>
          <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-slate-600">
            Practical calculators and tools to help you analyze, plan, and make smarter financial
            decisions.
          </p>
          ...
          <div className="flex items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">
                Start with DSO today. More tools are on the way.
              </p>
            </div>
          </div>
