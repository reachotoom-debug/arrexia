...
/** Shared article column width — keeps hero, body, and inline images aligned. */
const ARTICLE_COLUMN_CLASS = "min-w-0 max-w-3xl xl:max-w-none";
  ...
  return (
    <PublicPageShell>
      ...
      <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16">
        <div className="mx-auto grid max-w-6xl gap-10 xl:grid-cols-[minmax(0,1fr)_240px] xl:gap-14">
